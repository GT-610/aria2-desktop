...
class TaskParser {
  ...
  static DownloadTask parseTask(
    ...
    final totalLengthBytes =
        int.tryParse(taskData['totalLength'] as String? ?? '0') ?? 0;
    final completedLengthBytes =
        int.tryParse(taskData['completedLength'] as String? ?? '0') ?? 0;
    final downloadSpeedBytes =
    ...
    // Calculate progress
    double progress = totalLengthBytes > 0
        ? completedLengthBytes / totalLengthBytes
        : 0.0;
